...
defbindings("WScreen", {
    ...
    submap(META.."W", {
        ...
        --kpress("W", "ioncore.goto_activity() or ioncore.goto_previous()"),

        --bdoc("Go to previous active object."),
        --kpress("W", "ioncore.goto_previous()"),
    ...
    -- Volume keybindings
    kpress("XF86AudioRaiseVolume", "ioncore.exec('amixer sset Master 2%+')"),
    kpress("XF86AudioLowerVolume", "ioncore.exec('amixer sset Master 2%-')"),
...
defbindings("WClientWin", {
    ...
    kpress("Mod1+F4", "WRegion.rqclose_propagate(_, _sub)"),
    submap(META.."W", {kpress("C", "WClientWin.kill(_)"),
...
defmenu("mainmenu", {
    ...
    submenu("Apps",             "apps"),
    submenu("Screen",           "screen"),
    submenu("Shutdown",         "shutdown"),
})
...
-- Sutdown menu
defmenu("shutdown", {
    menuentry("poweroff",      "ioncore.exec('dbus-send --system --print-reply --dest=\"org.freedesktop.ConsoleKit\" /org/freedesktop/ConsoleKit/Manager org.freedesktop.ConsoleKit.Manager.Stop')"),
    menuentry("reboot",        "ioncore.exec('dbus-send --system --print-reply --dest=\"org.freedesktop.ConsoleKit\" /org/freedesktop/ConsoleKit/Manager org.freedesktop.ConsoleKit.Manager.Restart')"),
    menuentry("suspend",       "ioncore.exec('dbus-send --system --print-reply --dest=\"org.freedesktop.UPower\" /org/freedesktop/UPower org.freedesktop.UPower.Suspend')"),
})
...
-- Disable mouse focus
notioncore.set({mousefocus="disabled"})